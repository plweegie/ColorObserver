 ...
 *
 * Modifications copyright (C) 2017 Jan K. Szymanski
 */
...
public class PicoCamera {

    private static final String TAG = PicoCamera.class.getSimpleName();
    ...
    private static class InstanceHolder {
        private static PicoCamera mCamera = new PicoCamera();
    }

    public static PicoCamera getInstance() {
